...
const sampleProjection = [
  { id: "p1", player: "John Doe", stat: "points", line: 20 },
];

const contexts = {
  p1: {
    recentGames: [
      { date: "2025-11-01", statValue: 18 },
      { date: "2025-11-03", statValue: 22 },
    ],
    seasonAvg: 19.5,
    ...
    const arr = [
      {
        ...
        confidence: "High",
        numericEvidence: {
          recentGames: [{ statValue: 18 }, { statValue: 22 }],
          seasonAvg: 19.5,
          opponent: { name: "Rival", defensiveRating: 105.2, pace: 99.1 },
          projectedMinutes: 32,
        },
        reasoning: "Because recent games and season average support it.",
    ...
    const arr = [
      {
        ...
        reasoning: "Erroneous season avg",
