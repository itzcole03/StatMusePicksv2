...
import { calculateStatisticalEvidence, scoreToProbability, calculateExpectedValue, buildPredictionFromFeatures } from '../src/services/aiService.v2';
...
describe('aiService.v2 statistical helpers', () => {
  ...
  it('builds a prediction result with recommendation', () => {
    const pred = buildPredictionFromFeatures('Jane Doe', 'points', 12, [10, 11, 13, 14, 12], null);
