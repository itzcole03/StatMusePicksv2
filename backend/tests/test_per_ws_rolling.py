...
def _make_sample_games():
    dates = ['2025-10-01', '2025-10-03', '2025-10-05', '2025-10-07', '2025-10-09', '2025-10-11']
...
def test_adv_per_uses_rolling_proxy(monkeypatch):
    ...
    monkeypatch.setattr(nba_stats_client, 'fetch_recent_games', lambda pid, limit, season=None: games)
    monkeypatch.setattr(nba_stats_client, 'get_advanced_player_stats_multi', lambda pid, seasons=None: {})

    # generate training rows; use small min_games to keep test fast
    df = training_data_service.generate_training_data('Test Player', stat='points', min_games=3, fetch_limit=50)
