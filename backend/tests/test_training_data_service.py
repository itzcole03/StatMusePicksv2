...
def test_build_training_sample_monkeypatch(monkeypatch):
    ...
    sample = training_data_service.build_training_sample('Test Player', 'points', '2024-10-03', '2024-25')
...
def test_build_dataset_from_specs_monkeypatch(monkeypatch):
    ...
    specs = [
        {'player': 'A', 'stat': 'points', 'game_date': '2024-10-01', 'season': '2024-25', 'label': 21},
        {'player': 'B', 'stat': 'points', 'game_date': '2024-10-02', 'season': '2024-25', 'label': 19},
    ]
