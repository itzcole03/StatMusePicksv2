...
def sample_team_games():
    ...
    return [
        {"GAME_DATE": "2024-10-01", "PTS": 110, "OPP_PTS": 102, "FGA": 85, "FGM": 45, "FTA": 20, "FTM": 15},
        {"GAME_DATE": "2024-10-03", "PTS": 120, "OPP_PTS": 115, "FGA": 90, "FGM": 50, "FTA": 25, "FTM": 18},
        {"GAME_DATE": "2024-10-05", "PTS": 105, "OPP_PTS": 100, "FGA": 80, "FGM": 40, "FTA": 22, "FTM": 16},
    ]


def test_team_advanced_fallback_monkeypatch(monkeypatch):
    # Monkeypatch fetch_team_games to return synthetic logs
    monkeypatch.setattr(nbc, 'fetch_team_games', lambda team_id, limit=500, season=None: sample_team_games())
...
def test_team_advanced_multi_aggregation(monkeypatch):
    ...
    def fake_fetch(team_id, limit=500, season=None):
        if season == '2024-25':
            ...
            return [
                {"GAME_DATE": "2023-10-01", "PTS": 112, "OPP_PTS": 108, "FGA": 86, "FGM": 46, "FTA": 21, "FTM": 16},
            ]
