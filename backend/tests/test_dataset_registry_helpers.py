...
def test_list_and_latest_dataset_helpers_use_exported_manifests():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        m1 = tds.export_dataset_with_version(
            df, y=y, output_dir=td, name="myds", version="v1", fmt_prefer="csv"
        )
        m2 = tds.export_dataset_with_version(
            df, y=y, output_dir=td, name="myds", version="v2", fmt_prefer="csv"
        )
