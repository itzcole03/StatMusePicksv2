...
from backend.services.eval_report import load_model_if_exists, evaluate_model_on_df
...
# find model
candidates = list(models_dir.glob(f"{player}*.pkl")) + list(models_dir.glob(f"{player.replace(' ', '_')}*.pkl"))
