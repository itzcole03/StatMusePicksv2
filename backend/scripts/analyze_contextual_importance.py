...
def main():
    ...
    p.add_argument("--input", required=True, help="CSV or Parquet file with features + target")
    ...
    p.add_argument("--threshold", type=float, default=0.01, help="Importance threshold to select features")
    args = p.parse_args()
