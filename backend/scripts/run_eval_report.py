...
def find_model_file(models_dir: Path, player: str):
    ...
    patterns = [f"{player}.pkl", f"{player}_advanced*.pkl", f"{player}_*.pkl", f"{player}*.pkl",
                f"{player_safe}.pkl", f"{player_safe}_advanced*.pkl", f"{player_safe}_*.pkl", f"{player_safe}*.pkl"]
    for pat in patterns:
