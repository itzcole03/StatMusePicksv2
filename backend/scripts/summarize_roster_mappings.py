...
from backend.scripts.train_orchestrator_roster import (
    fetch_roster_names,
    map_roster_to_manifest,
)
...
def main(manifest: str, out_csv: str):
    ...
    mismatch_paths = [
        ...
        Path(
            "backend/models_store/roster_run_alias_subset/roster_mapping_mismatch.csv"
        ),
    ]
...
if __name__ == "__main__":
    ...
    p.add_argument(
        "--out-csv", default="backend/models_store/roster_mapping_summary.csv"
    )
    args = p.parse_args()
