...
def main():
    ...
    samples = [
        ("game:20250101", "Team A beat Team B 110-100. Star player recorded 30 points and left ankle appeared sore.", {"type": "game", "desc": "game summary"}),
        ("news:1001", "Star player X listed as questionable with an ankle sprain; trade rumors minimal.", {"type": "news", "player": "X"}),
        ("news:1002", "Coach fired after poor season; team morale low going into next game.", {"type": "news", "topic": "coach"}),
    ]
