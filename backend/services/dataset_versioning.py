...
def register_manifest(
    manifest_path: str, registry_dir: str = "backend/models_store/datasets"
) -> Optional[dict]:
...
def list_registered(
    name: Optional[str] = None, registry_dir: str = "backend/models_store/datasets"
) -> List[dict]:
...
def latest_registered(
    name: str, registry_dir: str = "backend/models_store/datasets"
) -> Optional[dict]:
...
def create_dataset_version(
    ...
    output_dir: str = "backend/data/datasets",
    ...
    m_train = export_dataset_with_version(
        df_train,
        None,
    ...
    m_val = export_dataset_with_version(
        df_val, None, output_dir=str(target), name=f"{base_name}_val", version=version
    )
    m_test = export_dataset_with_version(
        df_test, None, output_dir=str(target), name=f"{base_name}_test", version=version
    )
