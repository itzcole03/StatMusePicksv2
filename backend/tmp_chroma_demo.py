...
# Index sample items
items = [
    ('chroma_id1', 'Player scored 30 points and had a great game', {'text': 'scored 30 points'}),
    ('chroma_id2', 'Injury report: player sprained ankle and is questionable', {'text': 'sprained ankle'})
]
