...
def main():
    ...
    for i in outlier_idxs:
        r = recs[i]
        print(f'Index {i}: player_name={r.get("player_name") or r.get("player")}, player_nba_id={r.get("player_nba_id")}, stat_type={r.get("stat_type")}, value={r.get("value")}, game_date={r.get("game_date")}')
